...
import styles from '../../../../styles/my/profile/edit/MyProfileAdvice.module.css';

function MyProfileAdvice({ setProfileData, profileData }) {
    ...
    useEffect(() => {
        setSelectedAdvices(profileData.personal || []);
